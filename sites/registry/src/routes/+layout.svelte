...
<div class="min-h-screen flex flex-col">
	<nav
		class="flex items-center p-3 text-white gap-2"
	...
	<!-- FIXME: The footer doesn't *quite* stick to the bottom on the user page. -->
	<footer class="w-full z-10">
		<Section class="flex gap-2 flex-wrap mx-0 my-0 rounded-b-none *:flex *:flex-col">
			<!-- Commit Hash -->
			<div>
			...
			<!-- Last Modified -->
			<div>
				<label for="lastModified" class="font-bold">Last modified at</label>
				<p id="lastModified">{__LAST_MODIFIED__}</p>
			</div>
			...
			<!-- Authors -->
			<div>
				<label for="authors" class="font-bold">
					Made with <span class="text-red-500">&lt;3</span> by
				</label>
				<a id="authors" href="https://lunartides.dev" class="underline"> LunarTides </a>
			</div>
		</Section>
	</footer>
</div>
