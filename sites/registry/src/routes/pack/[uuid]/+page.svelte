...
{:then packs}
	...
	{:then cards}
		...
		<div class="m-2 p-5 bg-header rounded-xl">
			<details open>
	...
	<div class="m-2 p-5 bg-header rounded-xl">
		...
		{:then commentsObject}
			...
			<form
				...
				method="post"
				class="flex flex-col gap-1 rounded-xl mb-2"
				use:enhance
			>
				<textarea name="text" placeholder="Comment..." class="rounded-xl resize h-24 bg-background"
				></textarea>
				<button type="submit" class="custom-button p-2"> Post </button>
			</form>
