...
> Also ignore my awesome background image and transparent terminal. God i'm soo cool.
...
For now, you can ignore the other options, and just press Play.
...
You can look at the `decks.json` file for a list of pregenerated deckcodes, or [create your own](/guides/creating/decks/use). \
