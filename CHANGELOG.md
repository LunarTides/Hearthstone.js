#### 3.0.0-stable.0 (2025-12-05)

##### Chores

*  update `@hearthstonejs/vanillatypes` dependency ([babe974b](https://github.com/LunarTides/Hearthstone.js/commit/babe974bdaada8e28a939661675332f2d40afdaf))
*  use latest on all dependencies ([771dffe9](https://github.com/LunarTides/Hearthstone.js/commit/771dffe9d6f986ff4d7f227f5f08a48b8708a979))
*  add gitattributes file ([029d9643](https://github.com/LunarTides/Hearthstone.js/commit/029d96433583414220676b7852f099976bd9acef))
*  update changelog ([9254b26f](https://github.com/LunarTides/Hearthstone.js/commit/9254b26fa5caf5c3a10f9e7520cf41edbd623005))

##### New Features

*  add anniversary easter egg ([1069bb00](https://github.com/LunarTides/Hearthstone.js/commit/1069bb00cefbf3f3e168be3917a0697367024bef))
*  add localization support ([26eb2022](https://github.com/LunarTides/Hearthstone.js/commit/26eb2022ba2a1a8ca83cc5acecd756ee4b1610fa))
*  add Player.drawCards method ([426c2c31](https://github.com/LunarTides/Hearthstone.js/commit/426c2c31938952ab9d09d5dde04f6376b468e5db))
*  add frl command ([5cd307fc](https://github.com/LunarTides/Hearthstone.js/commit/5cd307fcb33d337da76ee7e1828b2f8c4f8cce5d))
*  add unlimited attacks keyword ([9affe3c7](https://github.com/LunarTides/Hearthstone.js/commit/9affe3c7a3e948cfe137c73ec479f174f8920a6b))
*  add Card.isAlive and Player.isAlive ([8642b695](https://github.com/LunarTides/Hearthstone.js/commit/8642b695ff26f8683f0ff29b52fe31dc0a371479))
*  add unbreakable keyword ([6c3493c1](https://github.com/LunarTides/Hearthstone.js/commit/6c3493c15c2eba363b1653feb4193809d5bc7f6f))
*  add joust keyword ([0f650a7f](https://github.com/LunarTides/Hearthstone.js/commit/0f650a7fe18f7153c1acd79ad689526dc6d81a2e))
*  add RevealCard event ([d4ae8c7a](https://github.com/LunarTides/Hearthstone.js/commit/d4ae8c7adf0050ce3858ef6f89a7429bc0aec8d4))
*  add forgetful keyword ([f9694e8b](https://github.com/LunarTides/Hearthstone.js/commit/f9694e8b9c6df8898de091bf6999909fdbba2627))
*  add Card.attackTarget and Player.attackTarget ([3757e42a](https://github.com/LunarTides/Hearthstone.js/commit/3757e42ad42a01fa3ae28cd0361cba1ac9801f4a))
*  add force attack ([1edc79fe](https://github.com/LunarTides/Hearthstone.js/commit/1edc79fe8ac0e1c656e405247b1b907f35ae83bd))
*  add discard function & event ([3d5e2824](https://github.com/LunarTides/Hearthstone.js/commit/3d5e282441db8ac6630566e1d4997b5819cf039e))
*  add ability to disable hero power ([baa29dd1](https://github.com/LunarTides/Hearthstone.js/commit/baa29dd128bb46db2162e2f826e31314492c278f))
*  add ability to cancel card removal ([41027388](https://github.com/LunarTides/Hearthstone.js/commit/4102738808afe743628c87b79a77cc53af8fcff0))
*  add SilenceCard event ([8617ae67](https://github.com/LunarTides/Hearthstone.js/commit/8617ae672232005b3b6dda9f17ec825ea9010153))
*  add card.hasStats ([bd0fae31](https://github.com/LunarTides/Hearthstone.js/commit/bd0fae315d5cc9e768f5e7ecf737c0dd79a84b82))
*  add game.functions.event.withSuppressed ([12fca368](https://github.com/LunarTides/Hearthstone.js/commit/12fca368a88b2ee4e6c8ac1cb83106b2f3038f7c))
*  add cant attack keyword ([d8d180b3](https://github.com/LunarTides/Hearthstone.js/commit/d8d180b378ed4bdc4868b2d8a8a3d3ba30c840c2))
*  add summon on draw keyword ([62242ac5](https://github.com/LunarTides/Hearthstone.js/commit/62242ac5bc80aa78571c6513de7c83b5fc670c20))
*  add debug log to save to log file ([6fb7a034](https://github.com/LunarTides/Hearthstone.js/commit/6fb7a03497426e76362cdabfae642e3065351ed5))
* **dc:**  add eval command ([4efbc6b0](https://github.com/LunarTides/Hearthstone.js/commit/4efbc6b06905fc7d40c104f6dbae1cb9b8318c99))
* **cli:**  add eval command ([4132722e](https://github.com/LunarTides/Hearthstone.js/commit/4132722ea165203b107f259cb52d06db7b8c2fbe))

##### Bug Fixes

*  fix fatigue bug ([0e04aa18](https://github.com/LunarTides/Hearthstone.js/commit/0e04aa180dd9e5ce7a0fc743fe5e4f028cb622a9))
*  move setting logger to createGame instead of hub ([cca5f96a](https://github.com/LunarTides/Hearthstone.js/commit/cca5f96a4dc1ab50e7f2eca64c9d27f215d34e1c))
*  dont skip pausing if failure in reload command ([003d44a0](https://github.com/LunarTides/Hearthstone.js/commit/003d44a0b26d821290b2c3ac712b4494e117a7bd))
*  broadcast Eval event even if error ([1a43c115](https://github.com/LunarTides/Hearthstone.js/commit/1a43c1159a7921f3d658898bee6e13063095e32b))
*  fix xo errors ([8e1b9fe0](https://github.com/LunarTides/Hearthstone.js/commit/8e1b9fe02902a6a04d33958cbd58b12825087687))
*  don't strikethrough text if the card doesn't have text ([ee65835f](https://github.com/LunarTides/Hearthstone.js/commit/ee65835fb1d3d071296a7149a0439321d00b8e7c))
*  make withSuppressed unsuppress all events ([27c8b1c8](https://github.com/LunarTides/Hearthstone.js/commit/27c8b1c8c08a400248cd75345df0c1aaf062f9a5))
*  fix card reloading and init backup order ([984010c6](https://github.com/LunarTides/Hearthstone.js/commit/984010c6b9f01c8eae7366d62fbfbdbb98953298))
*  make this work with bun ([6d6cb8c6](https://github.com/LunarTides/Hearthstone.js/commit/6d6cb8c6c367851ae49eadeb95857dd344f7db88))
*  prevent attacking with frozen cards ([5d3af5c4](https://github.com/LunarTides/Hearthstone.js/commit/5d3af5c4cc0c493e44b65bcdd7475cf5c3558869))
*  fix history / log file spamming ([84049110](https://github.com/LunarTides/Hearthstone.js/commit/8404911087700a4d090ae97ca831bd2b0d494b3e))
*  make silence more accurate to vanilla ([0e45fbcd](https://github.com/LunarTides/Hearthstone.js/commit/0e45fbcd2a431ff3407754f8a47d1ea8434a364d))
*  re-add ability for minions to give spelldamage ([6a0b1aec](https://github.com/LunarTides/Hearthstone.js/commit/6a0b1aec510d86960b862c49be15872ec8706ee8))
*  dont show build number if it is 0 ([610be48e](https://github.com/LunarTides/Hearthstone.js/commit/610be48ec014c8a03146265f67b3fbe73d175f1e))
* **cclib:**
  *  use multiline comment in passive text ([ef0c9bfe](https://github.com/LunarTides/Hearthstone.js/commit/ef0c9bfe79946fa465cc4b25c2ecb990e30405cc))
  *  change some replace to replaceAll ([d8ba7aa2](https://github.com/LunarTides/Hearthstone.js/commit/d8ba7aa20d76685c17443bbf5953194952e1d014))
  *  replace all " with ' in generated cards ([a0c7d686](https://github.com/LunarTides/Hearthstone.js/commit/a0c7d686a2690e89fac11edea4b30f831814aa92))
* **ai:**  prevent from attacking immune targets ([37277d56](https://github.com/LunarTides/Hearthstone.js/commit/37277d56147db34838e036ae04e64e4a2c59f73a))
* **cli:**  add workaround for spaces in arguments ([0d2bd202](https://github.com/LunarTides/Hearthstone.js/commit/0d2bd202cabc34fab3e5f8dd3ef09e1fba523e7e))

##### Other Changes

* ) ([72739950](https://github.com/LunarTides/Hearthstone.js/commit/727399509a46f21259370df37a81e5d10686e10c))
*  move event broadcasts to happen later ([cc05666e](https://github.com/LunarTides/Hearthstone.js/commit/cc05666eedb862637fac6724b2370473e71d99ac))
*  replace player.drawCard with player.drawCards ([f4a3b684](https://github.com/LunarTides/Hearthstone.js/commit/f4a3b6841b57562e8758de047cdd6945e83949aa))
*  game.board[][] -> player.board[] ([e1075262](https://github.com/LunarTides/Hearthstone.js/commit/e10752623181f4a49876b960f41a0745ab90b6c4))
*  remove game.log and related functions ([a18952ab](https://github.com/LunarTides/Hearthstone.js/commit/a18952abe1839cbcf53b009397fb8c04aae8e94c))
*  add logger and more debug log places ([f769a16e](https://github.com/LunarTides/Hearthstone.js/commit/f769a16e81e6645c4c01eff7ead270894bec5e53))
*  move getRemainingBoardSpace and handSize to player ([f412984c](https://github.com/LunarTides/Hearthstone.js/commit/f412984c90d9e113ff56eec05961d20e61f4a321))
*  make runCommand throw the error instead of returning it ([d650759d](https://github.com/LunarTides/Hearthstone.js/commit/d650759d1936f172b2358f29c04f252a3a5396b2))
*  remove game.Card ([cdfde06a](https://github.com/LunarTides/Hearthstone.js/commit/cdfde06a7ff459d40e40582a39d982c462e4a192))
*  remove support for nodejs, go all in on bun ([bb9c7e73](https://github.com/LunarTides/Hearthstone.js/commit/bb9c7e732bfc2de9de7adc4a298e88527bba08cb))
*  rename game.createCard to game.newCard ([d13e9017](https://github.com/LunarTides/Hearthstone.js/commit/d13e9017a96ea369569fed71c941de2bc1b9d93b))
*  some small docstring changes ([9e60f108](https://github.com/LunarTides/Hearthstone.js/commit/9e60f108708fba780878e2f04da802303cf967be))
*  remove card.turnFrozen ([00ef348f](https://github.com/LunarTides/Hearthstone.js/commit/00ef348f4dd7336cd28fdac4252b848c198ab115))
*  rename card.heroPower to card.heropower ([521d25b7](https://github.com/LunarTides/Hearthstone.js/commit/521d25b7af83c60ac7c34fed9b9d91c8f5083eac))
*  rename game.turns to game.turn ([2b2e809c](https://github.com/LunarTides/Hearthstone.js/commit/2b2e809cc8156985352351d28d720623d87211ad))
*  rename some core game functions ([7a5accd1](https://github.com/LunarTides/Hearthstone.js/commit/7a5accd18dd579e7ff406ffbe5464672445cf71a))
*  rename some events with minion to card ([146a0856](https://github.com/LunarTides/Hearthstone.js/commit/146a085677c196b3b86c8c62380c0f77faeb5556))
*  rename game.eventListeners to game.event.listeners ([3c34b737](https://github.com/LunarTides/Hearthstone.js/commit/3c34b7379123a89871ea5c7c425ae0f4e8e2ae6e))
*  rename game.events to game.event ([72da98f1](https://github.com/LunarTides/Hearthstone.js/commit/72da98f1f343da52554dd5447f61ae750f17f941))
*  small doc changes in card.ts ([0cbf7da9](https://github.com/LunarTides/Hearthstone.js/commit/0cbf7da96c031f807ef13cb23a18ccfa441bf341))
*  prevent card.ready from resetting attack times ([928c1d60](https://github.com/LunarTides/Hearthstone.js/commit/928c1d60adc64fddcde09a8264906dda6aad53bf))
*  enforce multiline comments in xo ([7aad3879](https://github.com/LunarTides/Hearthstone.js/commit/7aad38791f35e6b568ce72fb259a5ca6eb7dbe77))

##### Refactors

*  make propfinder format data in a more useful way ([d7314590](https://github.com/LunarTides/Hearthstone.js/commit/d73145908e700560d85c0bff629dbf420a417ed1))
*  add translate functions to logger ([26e77c1b](https://github.com/LunarTides/Hearthstone.js/commit/26e77c1b6b9c38fad36a406737117020f2fede1a))
*  use %s everywhere instead of ${} ([562c47d7](https://github.com/LunarTides/Hearthstone.js/commit/562c47d7899616ce2798aaaee3ba9c9e2c6cd009))
*  add functions.card.findFromUUID method ([4bacaec8](https://github.com/LunarTides/Hearthstone.js/commit/4bacaec8dd1b5d478b3aff000801ad86bb9a7c25))
*  add Player.getGraveyard method ([9a6b5b69](https://github.com/LunarTides/Hearthstone.js/commit/9a6b5b69e051a62b8567c3eee809c5775d74fa82))
*  move help bricks to the top of the file ([32e36e1a](https://github.com/LunarTides/Hearthstone.js/commit/32e36e1a3c92b112adce4af0ac596714fcea5640))
*  put vanilla card type in types file ([e21c3ce1](https://github.com/LunarTides/Hearthstone.js/commit/e21c3ce1f83c15569a85d6fc04e3b5891fe6cfc1))
*  upgrade to bun v1.0.23 ([f40c3114](https://github.com/LunarTides/Hearthstone.js/commit/f40c3114c0b6cc4896a16bd6641b70bc4d44b0f6))
*  broadcast RevealCard instead of adding to history ([63374874](https://github.com/LunarTides/Hearthstone.js/commit/63374874be52033a73d05d8ea48f0068e3908e26))
*  slightly change joust test card's text ([b14cd248](https://github.com/LunarTides/Hearthstone.js/commit/b14cd248d1e450b404d0da5827af65733bcc28a8))
*  add Player.shuffleDeck ([b45e11cd](https://github.com/LunarTides/Hearthstone.js/commit/b45e11cdb211357eb8fc03872e7e39bd5390f0a5))
*  improvements to _selectTarget ([4810a422](https://github.com/LunarTides/Hearthstone.js/commit/4810a422382d3467e37ac377f9c4e10de8be90d6))
*  move all attack validation to type branches ([485a8653](https://github.com/LunarTides/Hearthstone.js/commit/485a8653e2d491c0f06e69f6929b78a9f7f180f3))
*  add game.Card ([817a54b8](https://github.com/LunarTides/Hearthstone.js/commit/817a54b84dfd208c27c81547ff029a3e94809127))
*  use game.createCard everywhere instead of new Card ([7d0b92af](https://github.com/LunarTides/Hearthstone.js/commit/7d0b92af6f1b402b63afa350f70f0bb89cd8a654))
*  cleanup some old game code ([45b80661](https://github.com/LunarTides/Hearthstone.js/commit/45b806615443e26e9d1dcd717ee070bd7f2f8636))
*  add player.getBoard ([9931e743](https://github.com/LunarTides/Hearthstone.js/commit/9931e74353eaece60b36c60f9560f0a37aa92f1c))
*  don't summon minion if it can't be on the board ([7230050f](https://github.com/LunarTides/Hearthstone.js/commit/7230050f58ab5fbddb8b995138db2dcb79bcc058))
*  add card.canBeAttacked instead of ai._canTargetMinion ([fccf6bc9](https://github.com/LunarTides/Hearthstone.js/commit/fccf6bc9d57672121ec653c2edb5bb5b9c9291cf))
*  some doc and perf improvements in game.summonMinion ([0295d563](https://github.com/LunarTides/Hearthstone.js/commit/0295d563b8774c328d3096a60ca0b611329d595c))
*  add a player.summon function ([5c43712d](https://github.com/LunarTides/Hearthstone.js/commit/5c43712dd2fc05bf8f77f62733ad4ab4e7ff7651))
*  split eval parsing logic into interact ([c3b36561](https://github.com/LunarTides/Hearthstone.js/commit/c3b365617eac27b1633e8394f823802493847fa2))
* **pf:**  add prop whitelist ([a8db2942](https://github.com/LunarTides/Hearthstone.js/commit/a8db2942abcaac27115e9437c523fb5c599e49ae))
* **tc:**  remove failed variable and use exitCode instead ([95809915](https://github.com/LunarTides/Hearthstone.js/commit/95809915274a713524e9b4337e33a0bf946005b8))
* **vcc:**  remove asking for debug mode ([df6d39f6](https://github.com/LunarTides/Hearthstone.js/commit/df6d39f6d99eb92c4411f8e6a1e9a91136eebfcc))
* **cclib:**  remove global variables ([0e4b81b9](https://github.com/LunarTides/Hearthstone.js/commit/0e4b81b9a53c8630edc8bd05582897596c1c3418))

##### Tests

*  add remaining test files ([8c5955ee](https://github.com/LunarTides/Hearthstone.js/commit/8c5955eef8e7a7d52893e0e022da128c77bd6043))
*  add test files for all function submodules ([937dea10](https://github.com/LunarTides/Hearthstone.js/commit/937dea10be8765f87737dc440292f428cbf6840d))
*  began adding src tests ([cee30d30](https://github.com/LunarTides/Hearthstone.js/commit/cee30d3052f3f782e8101cb2c41361e0dbd7dfbd))
*  add test to summon on draw example card ([09300df0](https://github.com/LunarTides/Hearthstone.js/commit/09300df02fe1ea97655da6094c5eca812c9630c9))
*  optimize tests ([f693ae8a](https://github.com/LunarTides/Hearthstone.js/commit/f693ae8a80a3dc88da8c4627e96f891300cfa8df))
