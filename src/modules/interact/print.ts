...
const funFacts = [
	...
	"The cards uses the exact same API that the game uses, and the game has many hooks. This allows cards near complete control over the game. If there is anything you <i>can't</i> do with cards, open an issue on Forgejo / GitHub, and I'll see what I can do!",
